...
$launchEnvironment = @{ CodexTest__Enabled = 'false'; Llm__AllowDevelopmentStub = 'false' }
...
# Evaluate deletions and changed build policy as well as modified source files.
dotnet restore $apiProject --locked-mode --configfile (Join-Path $projectRoot 'NuGet.Config')
